...
*/
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite um dado de quatro digitos a ser criptografado: ");
		dado = leitor.nextInt();
		criptografa(dado);
		
	}
	public static void criptografa(int dado)
	{
		int primeiro, segundo, terceiro, quarto;
		quarto = (((dado%10)+7)%10);
		dado = dado/10;
		terceiro = (((dado%10)+7)%10);
		dado /= 10;
		segundo =(((dado%10)+7)%10);
		dado /= 10;
		primeiro = (((dado%10)+7)%10);
